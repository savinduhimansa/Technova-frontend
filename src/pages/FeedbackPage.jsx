...
const FeedbackPage = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#DBEAFE] via-[#E0ECFF] to-white flex items-center justify-center py-16 px-6 relative overflow-hidden">
      {/* Soft radial glows in Blue Horizon */}
      ...
      {/* Content wrapper */}
      <div className="relative z-10 w-full max-w-7xl flex flex-col lg:flex-row gap-10 bg-white/70 border border-[#BFDBFE] rounded-3xl shadow-xl backdrop-blur-md p-8">
        {/* Feedback Form panel */}
